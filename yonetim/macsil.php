...
<tr>
  <th height="35" colspan="4" scope="col" align="center">Maçı Sil</th>
  </tr>
<tr>
...
<tr>
  <td height="62" colspan="4" align="center"><input type="submit" value="Maçı Sil..!"></td>
  </tr>
</table>
...
$maclar=mysql_query("delete from maclar where mackodu=$kod");
	if($maclar){
