...
<tr>
  <th colspan="7" scope="col">Maç Ayarları</th>
</tr>
<tr>
...
if($kod==$maclar["mackodu"]){

	echo $maclar["ev"];
	 echo"-"; 
	 echo $maclar["misafir"];
echo "<tr><td colspan='2'  align='center'><input type='button' value='Maçı Düzenle..!' onClick=location.href='macduzenle.php'><input type='button' value='Maçı Sil..!' onClick=location.href='macsil.php'></td>";

}
else{

echo"Böyle Bir Maç Yok..!"; 
echo "<tr><td colspan='2'  align='center'><input type='button' value='Maç Ekle..!' onClick=location.href='macekle.php'></td></tr>";}
}
?>
</td>
</tr>
